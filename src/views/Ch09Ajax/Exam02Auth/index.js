...
function Exam02Auth(props) {
  ...
  const handleLogin = async (event) => {
    try {
      ...
      dispatch(createSetAuthToken(response.data.authToken));
  ...
  return (
    <div className="card">
      ...
      <div>
        <button className="btn btn-info btn-sm" onClick={handleBoardList}>게시물 목록(인증필요)</button>
        </div>
      <div className="card-body">
        {globalUid === "" ? (
          <div>
            ...
            <div className="form-group row">
              <label htmlFor="upassword" className="col-sm-2 col-form-label">
                User Password
              </label>
              <div className="col-sm-10">
